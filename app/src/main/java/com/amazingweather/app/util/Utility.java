...
import com.amazingweather.app.model.AmazingWeatherDB;
...
public class Utility {
    ...
    //解析和处理服务器返回的市级数据
    public static boolean handleCitiesResponse(AmazingWeatherDB amazingWeatherDB,String response,int provinceId){
        if (!TextUtils.isEmpty(response)){
    ...
    //解析和处理服务器返回的县级数据
    public static boolean handleCountiesResponse(AmazingWeatherDB amazingWeatherDB,String response,int cityId){
        if (!TextUtils.isEmpty(response)){
